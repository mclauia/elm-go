...
Elm.Go.make = function (_elm) {
   "use strict";
   _elm.Go = _elm.Go || {};
   if (_elm.Go.values) return _elm.Go.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   var isStarPoint = F2(function (location,boardSize) {
      ...
      function () {
         var _p0 = boardSize;
         switch (_p0)
         {case 19: return _U.list([{ctor: "_Tuple2",_0: 3,_1: 3}
            ...
            case 13: return _U.list([{ctor: "_Tuple2",_0: 3,_1: 3},{ctor: "_Tuple2",_0: 3,_1: 9},{ctor: "_Tuple2",_0: 9,_1: 3},{ctor: "_Tuple2",_0: 9,_1: 9}]);
            case 9: return _U.list([{ctor: "_Tuple2",_0: 2,_1: 2},{ctor: "_Tuple2",_0: 2,_1: 6},{ctor: "_Tuple2",_0: 6,_1: 2},{ctor: "_Tuple2",_0: 6,_1: 6}]);
            default: return _U.list([]);}
      }());
   });
   var drawPointLines = F2(function (location,boardSize) {
      var isWestEdge = _U.eq($Matrix.col(location),boardSize - 1);
   ...
   var attemptMove = F2(function (model,location) {
      ...
      var updatedModel = isLegalMove ? _U.update(model,
   ...
   var update = F2(function (action,model) {
      var _p8 = action;
      switch (_p8.ctor)
      {case "Move": return model.isClockPaused || isEndOfGame(model) ? model : A2(attemptMove,model,_p8._0);
         case "Reset": return initialModel(_p8._0);
         case "Tick": return model.isClockPaused ? model : decrementTime(model);
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2(viewBoard,address,model),A2(viewSidePane,address,model)]));
   });
   var main = function () {
      var state = initialModel(19);
      var actions = $Signal.mailbox(NoOp);
      var inputs = $Signal.mergeMany(_U.list([actions.signal,A2($Signal.map,Tick,$Time.every($Time.second))]));
      var model = A3($Signal.foldp,update,state,inputs);
      return A2($Signal.map,view(actions.address),model);
   }();
   return _elm.Go.values = {_op: _op
                           ,main: main
                           ,Black: Black
                           ,White: White
